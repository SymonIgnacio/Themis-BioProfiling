    ...
    try:
        ...
        for visitor_data in approved_visitors:
            try:
                ...
                approved_query = text("""
                    INSERT INTO approvedvisitors (pupc_id, first_name, last_name, relationship, email, visitor_id, user_id, username, password, account_created)
                    VALUES (:pupc_id, :first_name, :last_name, :relationship, :email, :visitor_id, :user_id, :username, :password, 1)
                """)
...
def create_approved_visitor(pupc_id, visitor_data):
    try:
        ...
        # Use a simpler query with fewer fields to reduce chance of errors
        approved_query = text("""
            INSERT INTO approvedvisitors 
            (pupc_id, first_name, last_name, visitor_id, user_id, username, password) 
            VALUES 
            (:pupc_id, :first_name, :last_name, :visitor_id, :user_id, :username, :password)
        """)
